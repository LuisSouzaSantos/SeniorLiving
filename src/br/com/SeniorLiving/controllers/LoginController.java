...
public class LoginController extends Controller implements Initializable {
	...
	public void performLogin() throws LoginException, IOException {
		try {
			if(txtEmail == null || txtEmail.getText().trim().isEmpty()) { infoBox("Email n�o pode estar em branco"); } 
			
			if(txtPassword == null || txtPassword.getText().trim().isEmpty()) { infoBox("Senha n�o pode estar em branco"); } 
