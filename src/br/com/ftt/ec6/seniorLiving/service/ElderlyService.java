...
public interface ElderlyService {
	Elderly save(String name, MaritalStatus maritalStatus, String nationality, String rg, String cpf, LocalDate birthDate, 
			BigDecimal monthlyPayment, Person curator, Person sympathetic, RestHome restHome, Accommodation accommodation, List<Billing> billingList) throws ElderlyException;
	
	Elderly update(Elderly elderly) throws ElderlyException;
